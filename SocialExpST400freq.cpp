...
//
// to compile the code type g++ SocialExpST400freq.cpp -o SocialExpST400freq -lm
      ...
      while( t<tmax )
	{
      ...
      mutationselection(&sequence1,Npop,t,Genomesite);
        ...
        if((t%TSample)==0){
            ...
            sprintf(arq2,"SocialExpS400f-N%d-Ud%lf-Ua%lf-Sd%lf-Sa%lf-MIG%lf.txt",Npop,sequence.U,sequence.Ub,sequence.sd,sequence.samedio,MIG);
            ptt2 = fopen(arq2,"a");
            fprintf(ptt2," \n %d \t", t);
            ...
            if(sequence.Ftot>0)
            {
                sprintf(arq1,"SocialExpS400res-N%d-Ud%lf-Ua%lf-Sd%lf-Sa%lf.txt",Npop,sequence.U,sequence.Ub,sequence.sd,sequence.samedio);
                ptt1 = fopen(arq1,"a");
